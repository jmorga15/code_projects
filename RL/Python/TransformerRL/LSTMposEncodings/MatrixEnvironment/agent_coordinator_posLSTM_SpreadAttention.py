...
class Agent():
    def __init__(self, alpha, beta, input_dims, tau, env,
        ...
        self.actor = ActorNetwork(alpha, input_dims=32, hidden_dim = 256, fc1_dims=128, fc2_dims=64, n_actions=n_actions, name='actor_transformer3', chkpt_dir='td3_MAT').to(self.device)
        self.critic_1 = CriticNetwork(beta, input_dims=32, hidden_dim = 256, fc1_dims=128, fc2_dims=64, n_actions=n_actions,
            name='critic_1_transformer3', chkpt_dir='td3_MAT').to(self.device)
        self.critic_2 = CriticNetwork(beta, input_dims=32, hidden_dim = 256, fc1_dims=128, fc2_dims=64, n_actions=n_actions,
            name='critic_2_transformer3', chkpt_dir='td3_MAT').to(self.device)

        self.target_actor = ActorNetwork(alpha, input_dims=32, hidden_dim = 256, fc1_dims=128, fc2_dims=64, n_actions=n_actions, name='target_actor_transformer3', chkpt_dir='td3_MAT').to(self.device)
        self.target_critic_1 = CriticNetwork(beta, input_dims=32, hidden_dim = 256, fc1_dims=128, fc2_dims=64, n_actions=n_actions,
            name='target_critic_1_transformer3', chkpt_dir='td3_MAT').to(self.device)
        self.target_critic_2 = CriticNetwork(beta, input_dims=32, hidden_dim = 256, fc1_dims=128, fc2_dims=64, n_actions=n_actions,
            name='target_critic_2_transformer3', chkpt_dir='td3_MAT').to(self.device)
